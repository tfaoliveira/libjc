(* @JBA: TODO: remove unbounded "smt" calls *)
...
proof. by rewrite of_intwE /int_bit modz_small. qed.
...
(* --------------------------------------------------------------------- *)
(* Link between bitwise operations and arithmetic operations             *)
...
proof. 
move=> *; apply/wordP => i Hi /=; rewrite !Hi /=.
smt.
qed.
