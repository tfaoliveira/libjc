...
module M = {
  ...
  proc perm_x2 (k:W256.t Array4.t) : W256.t Array4.t = {
    ...
    pk <- witness;
    pk.[0] <- x86_VPERM2I128 k.[0] k.[1] (W8.of_int (0 %% 2^4 + 2^4 * 2));
    pk.[1] <- x86_VPERM2I128 k.[2] k.[3] (W8.of_int (0 %% 2^4 + 2^4 * 2));
    pk.[2] <- x86_VPERM2I128 k.[0] k.[1] (W8.of_int (1 %% 2^4 + 2^4 * 3));
    pk.[3] <- x86_VPERM2I128 k.[2] k.[3] (W8.of_int (1 %% 2^4 + 2^4 * 3));
    return (pk);
  }
