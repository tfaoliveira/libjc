...
sha3384_avx2_jazz:
	...
	jmp 	Lsha3384_avx2_jazz$17
Lsha3384_avx2_jazz$18:
	movq	(%rsi), %r10
	movq	%r10, (%rsp)
	movq	%r10, 8(%rsp)
	movq	%r10, 16(%rsp)
...
Lsha3384_avx2_jazz$19:
	...
	leaq	32(%rbp), %rbp
	decl	%ebx
	jne 	Lsha3384_avx2_jazz$19
Lsha3384_avx2_jazz$17:
	cmpq	$104, %rdx
	jnb 	Lsha3384_avx2_jazz$18
	vpbroadcastq	g_zero(%rip), %ymm0
	vmovdqu	%ymm0, (%rsp)
	vmovdqu	%ymm0, 32(%rsp)
	vmovdqu	%ymm0, 64(%rsp)
	...
	shrq	$3, %r10
	movq	$0, %r11
	jmp 	Lsha3384_avx2_jazz$15
Lsha3384_avx2_jazz$16:
	movq	(%rsi,%r11,8), %rbp
	movq	(%rcx,%r11,8), %rbx
	movq	%rbp, (%rsp,%rbx,8)
	leaq	1(%r11), %r11
Lsha3384_avx2_jazz$15:
	cmpq	%r10, %r11
	jb  	Lsha3384_avx2_jazz$16
	movq	(%rcx,%r11,8), %r10
	shlq	$3, %r11
	shlq	$3, %r10
	jmp 	Lsha3384_avx2_jazz$13
Lsha3384_avx2_jazz$14:
	movb	(%rsi,%r11), %bpl
	movb	%bpl, (%rsp,%r10)
	leaq	1(%r11), %r11
	leaq	1(%r10), %r10
Lsha3384_avx2_jazz$13:
	cmpq	%rdx, %r11
	jb  	Lsha3384_avx2_jazz$14
	movb	$6, (%rsp,%r10)
	movq	$12, %rdx
	movq	(%rcx,%rdx,8), %rdx
	shlq	$3, %rdx
...
Lsha3384_avx2_jazz$7:
	...
	leaq	32(%r11), %r11
	decl	%ebp
	jne 	Lsha3384_avx2_jazz$7
	leaq	-104(%rdx), %rdx
Lsha3384_avx2_jazz$5:
	cmpq	$104, %rdx
	jnb 	Lsha3384_avx2_jazz$6
	vmovdqu	%ymm0, (%rsp)
	vmovdqu	%ymm1, 32(%rsp)
	vmovdqu	%ymm2, 64(%rsp)
	vmovdqu	%ymm3, 96(%rsp)
