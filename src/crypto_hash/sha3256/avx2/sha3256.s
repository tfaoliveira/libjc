	.text
	.p2align	5
	.globl	_sha3256_avx2_jazz
	.globl	sha3256_avx2_jazz
_sha3256_avx2_jazz:
sha3256_avx2_jazz:
	pushq	%rbp
	pushq	%rbx
	...
	movq	16(%rcx), %r9
	movq	24(%rcx), %rcx
	jmp 	Lsha3256_avx2_jazz$17
Lsha3256_avx2_jazz$18:
	movq	40(%rsi), %r10
	movq	80(%rsi), %r11
	movq	120(%rsi), %rbp
	movq	%r11, 224(%rsp)
...
Lsha3256_avx2_jazz$19:
	...
	leaq	32(%rbp), %rbp
	decl	%ebx
	jne 	Lsha3256_avx2_jazz$19
Lsha3256_avx2_jazz$17:
	cmpq	$136, %rdx
	jnb 	Lsha3256_avx2_jazz$18
	...
	shrq	$3, %r10
	movq	$0, %r11
	jmp 	Lsha3256_avx2_jazz$15
Lsha3256_avx2_jazz$16:
	movq	(%rsi,%r11,8), %rbp
	movq	(%rcx,%r11,8), %rbx
	movq	%rbp, (%rsp,%rbx,8)
	leaq	1(%r11), %r11
Lsha3256_avx2_jazz$15:
	cmpq	%r10, %r11
	jb  	Lsha3256_avx2_jazz$16
	movq	(%rcx,%r11,8), %r10
	shlq	$3, %r11
	shlq	$3, %r10
	jmp 	Lsha3256_avx2_jazz$13
Lsha3256_avx2_jazz$14:
	movb	(%rsi,%r11), %bpl
	movb	%bpl, (%rsp,%r10)
	leaq	1(%r11), %r11
	leaq	1(%r10), %r10
Lsha3256_avx2_jazz$13:
	cmpq	%rdx, %r11
	jb  	Lsha3256_avx2_jazz$14
	movb	$6, (%rsp,%r10)
	movq	$16, %rdx
	movq	(%rcx,%rdx,8), %rdx
	shlq	$3, %rdx
...
Lsha3256_avx2_jazz$12:
	...
	leaq	32(%r10), %r10
	decl	%r11d
	jne 	Lsha3256_avx2_jazz$12
	movq	$32, %rdx
	jmp 	Lsha3256_avx2_jazz$5
Lsha3256_avx2_jazz$6:
	movq	$136, %rsi
	vmovdqu	%ymm0, (%rsp)
	vmovdqu	%ymm1, 32(%rsp)
	vmovdqu	%ymm2, 64(%rsp)
	...
	shrq	$3, %r10
	movq	$0, %r11
	jmp 	Lsha3256_avx2_jazz$10
Lsha3256_avx2_jazz$11:
	movq	(%rcx,%r11,8), %rbp
	movq	(%rsp,%rbp,8), %rbp
	movq	%rbp, (%rdi,%r11,8)
	leaq	1(%r11), %r11
Lsha3256_avx2_jazz$10:
	cmpq	%r10, %r11
	jb  	Lsha3256_avx2_jazz$11
	movq	(%rcx,%r11,8), %r10
	shlq	$3, %r11
	shlq	$3, %r10
	jmp 	Lsha3256_avx2_jazz$8
Lsha3256_avx2_jazz$9:
	movb	(%rsp,%r10), %bpl
	movb	%bpl, (%rdi,%r11)
	leaq	1(%r11), %r11
	leaq	1(%r10), %r10
Lsha3256_avx2_jazz$8:
	cmpq	%rsi, %r11
	jb  	Lsha3256_avx2_jazz$9
	leaq	(%rdi,%rsi), %rdi
	leaq	96(%rax), %rsi
	leaq	96(%r8), %r10
	movq	%r9, %r11
...
Lsha3256_avx2_jazz$7:
	...
	leaq	32(%r11), %r11
	decl	%ebp
	jne 	Lsha3256_avx2_jazz$7
	leaq	-136(%rdx), %rdx
Lsha3256_avx2_jazz$5:
	cmpq	$136, %rdx
	jnb 	Lsha3256_avx2_jazz$6
	vmovdqu	%ymm0, (%rsp)
	vmovdqu	%ymm1, 32(%rsp)
	vmovdqu	%ymm2, 64(%rsp)
	vmovdqu	%ymm3, 96(%rsp)
	...
	shrq	$3, %rax
	movq	$0, %rsi
	jmp 	Lsha3256_avx2_jazz$3
Lsha3256_avx2_jazz$4:
	movq	(%rcx,%rsi,8), %r8
	movq	(%rsp,%r8,8), %r8
	movq	%r8, (%rdi,%rsi,8)
	leaq	1(%rsi), %rsi
Lsha3256_avx2_jazz$3:
	cmpq	%rax, %rsi
	jb  	Lsha3256_avx2_jazz$4
	movq	(%rcx,%rsi,8), %rax
	shlq	$3, %rsi
	shlq	$3, %rax
	jmp 	Lsha3256_avx2_jazz$1
Lsha3256_avx2_jazz$2:
	movb	(%rsp,%rax), %cl
	movb	%cl, (%rdi,%rsi)
	leaq	1(%rsi), %rsi
	leaq	1(%rax), %rax
Lsha3256_avx2_jazz$1:
	cmpq	%rdx, %rsi
	jb  	Lsha3256_avx2_jazz$2
	addq	$256, %rsp
	popq	%rbx
	popq	%rbp
	ret 
