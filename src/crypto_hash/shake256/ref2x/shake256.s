...
shake256_ref2x_jazz:
	...
	xorl	%eax, %eax
	movq	$0, %rcx
	jmp 	Lshake256_ref2x_jazz$22
Lshake256_ref2x_jazz$23:
	movq	%rax, (%rsp,%rcx,8)
	leaq	1(%rcx), %rcx
Lshake256_ref2x_jazz$22:
	cmpq	$25, %rcx
	jb  	Lshake256_ref2x_jazz$23
	jmp 	Lshake256_ref2x_jazz$19
...
Lshake256_ref2x_jazz$21:
	...
	leaq	16(%r8), %r8
	testb	$-1, %r8b
	jne 	Lshake256_ref2x_jazz$21
	leaq	-192(%r8), %r8
	movq	216(%rsp), %rsi
	movq	208(%rsp), %rdx
Lshake256_ref2x_jazz$19:
	cmpq	$136, %rdx
	jnb 	Lshake256_ref2x_jazz$20
	movq	%rdx, %rax
	shrq	$3, %rax
	movq	$0, %rdi
...
Lshake256_ref2x_jazz$17:
	cmpq	%rax, %rdi
	jb  	Lshake256_ref2x_jazz$18
	leaq	(%rsi,%rdi,8), %r9
	andq	$7, %rdx
	movq	$0, %rsi
	movq	$0, %rcx
	testb	$4, %dl
	je  	Lshake256_ref2x_jazz$16
	movl	(%r9), %esi
	leaq	4(%r9), %r9
	movq	$32, %rcx
Lshake256_ref2x_jazz$16:
	testb	$2, %dl
	je  	Lshake256_ref2x_jazz$15
	movzwq	(%r9), %rax
	leaq	2(%r9), %r9
	shlq	%cl, %rax
	leaq	16(%rcx), %rcx
...
Lshake256_ref2x_jazz$13:
	...
	leaq	16(%r8), %r8
	testb	$-1, %r8b
	jne 	Lshake256_ref2x_jazz$13
	leaq	-192(%r8), %r8
	movq	432(%rsp), %rax
	cmpq	$136, 200(%rsp)
	jnb 	Lshake256_ref2x_jazz$3
	movq	200(%rsp), %rcx
	movq	%rcx, %rdx
	shrq	$3, %rdx
	movq	$0, %rsi
	jmp 	Lshake256_ref2x_jazz$11
...
Lshake256_ref2x_jazz$11:
	cmpq	%rdx, %rsi
	jb  	Lshake256_ref2x_jazz$12
	shlq	$3, %rsi
	jmp 	Lshake256_ref2x_jazz$9
...
Lshake256_ref2x_jazz$9:
	cmpq	%rcx, %rsi
	jb  	Lshake256_ref2x_jazz$10
	leaq	(%rax,%rcx), %rax
	movq	$0, 200(%rsp)
	jmp 	Lshake256_ref2x_jazz$4
Lshake256_ref2x_jazz$3:
	movq	$136, %rcx
	movq	%rcx, %rdx
	shrq	$3, %rdx
	movq	$0, %rsi
	jmp 	Lshake256_ref2x_jazz$7
...
Lshake256_ref2x_jazz$5:
	cmpq	%rcx, %rsi
	jb  	Lshake256_ref2x_jazz$6
	leaq	(%rax,%rcx), %rax
	subq	$136, 200(%rsp)
Lshake256_ref2x_jazz$4:
Lshake256_ref2x_jazz$1:
	cmpq	$0, 200(%rsp)
	jnle	Lshake256_ref2x_jazz$2
	addq	$440, %rsp
	popq	%r12
	popq	%rbx
	popq	%rbp
