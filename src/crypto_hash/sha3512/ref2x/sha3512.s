...
sha3512_ref2x_jazz:
	...
	xorl	%ecx, %ecx
	movq	$0, %rdi
	jmp 	Lsha3512_ref2x_jazz$14
Lsha3512_ref2x_jazz$15:
	movq	%rcx, (%rsp,%rdi,8)
	leaq	1(%rdi), %rdi
Lsha3512_ref2x_jazz$14:
	cmpq	$50, %rdi
	jb  	Lsha3512_ref2x_jazz$15
...
Lsha3512_ref2x_jazz$9:
	...
	movq	$0, %rcx
	testb	$4, %dl
	je  	Lsha3512_ref2x_jazz$8
	movl	(%r9), %r8d
	leaq	4(%r9), %r9
	movq	$32, %rcx
Lsha3512_ref2x_jazz$8:
	testb	$2, %dl
	je  	Lsha3512_ref2x_jazz$7
	movzwq	(%r9), %rsi
	leaq	2(%r9), %r9
	shlq	%cl, %rsi
	leaq	16(%rcx), %rcx
