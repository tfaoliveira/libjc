...
Lkeccak_1600$16:
	...
	vmovdqu	48(%rdx), %ymm1
	vmovdqu	88(%rdx), %ymm5
	vbroadcasti128	128(%rdx), %ymm6
	vpblendd	$-13, %ymm0, %ymm6, %ymm7
	vpblendd	$-4, %ymm0, %ymm6, %ymm6
	vpblendd	$-61, %ymm1, %ymm5, %ymm8
	vpblendd	$60, %ymm1, %ymm5, %ymm1
	vpblendd	$-16, %ymm0, %ymm8, %ymm5
	vpblendd	$-52, %ymm0, %ymm1, %ymm0
	vpblendd	$51, %ymm6, %ymm1, %ymm1
