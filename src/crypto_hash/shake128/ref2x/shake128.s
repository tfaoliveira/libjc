...
shake128_ref2x_jazz:
	...
	xorl	%eax, %eax
	movq	$0, %rcx
	jmp 	Lshake128_ref2x_jazz$22
Lshake128_ref2x_jazz$23:
	movq	%rax, (%rsp,%rcx,8)
	leaq	1(%rcx), %rcx
Lshake128_ref2x_jazz$22:
	cmpq	$25, %rcx
	jb  	Lshake128_ref2x_jazz$23
	jmp 	Lshake128_ref2x_jazz$19
...
Lshake128_ref2x_jazz$21:
	...
	leaq	16(%r8), %r8
	testb	$-1, %r8b
	jne 	Lshake128_ref2x_jazz$21
	leaq	-192(%r8), %r8
	movq	216(%rsp), %rsi
	movq	208(%rsp), %rdx
Lshake128_ref2x_jazz$19:
	cmpq	$168, %rdx
	jnb 	Lshake128_ref2x_jazz$20
	movq	%rdx, %rax
	shrq	$3, %rax
	movq	$0, %rdi
...
Lshake128_ref2x_jazz$17:
	cmpq	%rax, %rdi
	jb  	Lshake128_ref2x_jazz$18
	leaq	(%rsi,%rdi,8), %r9
	andq	$7, %rdx
	movq	$0, %rsi
	movq	$0, %rcx
	testb	$4, %dl
	je  	Lshake128_ref2x_jazz$16
	movl	(%r9), %esi
	leaq	4(%r9), %r9
	movq	$32, %rcx
Lshake128_ref2x_jazz$16:
	testb	$2, %dl
	je  	Lshake128_ref2x_jazz$15
	movzwq	(%r9), %rax
	leaq	2(%r9), %r9
	shlq	%cl, %rax
	leaq	16(%rcx), %rcx
...
Lshake128_ref2x_jazz$9:
	...
	leaq	(%rax,%rcx), %rax
	movq	$0, 200(%rsp)
	jmp 	Lshake128_ref2x_jazz$4
Lshake128_ref2x_jazz$3:
	movq	$168, %rcx
	movq	%rcx, %rdx
	shrq	$3, %rdx
	movq	$0, %rsi
	jmp 	Lshake128_ref2x_jazz$7
...
Lshake128_ref2x_jazz$5:
	cmpq	%rcx, %rsi
	jb  	Lshake128_ref2x_jazz$6
	leaq	(%rax,%rcx), %rax
	subq	$168, 200(%rsp)
Lshake128_ref2x_jazz$4:
Lshake128_ref2x_jazz$1:
	cmpq	$0, 200(%rsp)
	jnle	Lshake128_ref2x_jazz$2
	addq	$440, %rsp
	popq	%r12
	popq	%rbx
	popq	%rbp
