...
typedef __attribute__ ((aligned (32))) u64 EltFp25519_1w_x64[NUM_WORDS_ELTFP25519_X64];
typedef __attribute__ ((aligned (32))) u64 EltFp25519_1w_Buffer_x64[2 * NUM_WORDS_ELTFP25519_X64];
...
#define sqr_EltFp25519_1w_x64_adx(a) \
	sqr_256x256_integer_x64_adx(buffer_1w, a); \
	red_EltFp25519_1w_x64_adx(a, buffer_1w);

#define sqr_EltFp25519_1w_x64_bmi2(a) \
	sqr_256x256_integer_x64_bmi2(buffer_1w, a); \
...
#define sqr_EltFp25519_2w_x64_adx(a) \
	sqr2_256x256_integer_x64_adx(buffer_2w, a); \
	red_EltFp25519_2w_x64_bmi2(a, buffer_2w);

#define sqr_EltFp25519_2w_x64_bmi2(a) \
	sqr2_256x256_integer_x64_bmi2(buffer_2w, a); \
	red_EltFp25519_2w_x64_bmi2(a, buffer_2w);
...
__attribute__ ((aligned (32))) static const u64 Table_Ladder_8k[252 * NUM_WORDS_ELTFP25519_X64] = {
 ...
 * @param a
 */
static void sqr2_256x256_integer_x64_adx(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
		"movq   (%1), %%rdx        ;" /* A[0]      */
...
static void sqr2_256x256_integer_x64_bmi2(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
		"movq  8(%1), %%rdx        ;" /* A[1]      */
 ...
 * @param a
 */
void red_EltFp25519_2w_x64_adx(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
...
void red_EltFp25519_2w_x64_bmi2(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
		"movl    $38, %%edx ; "       /* 2*c = 38 = 2^256 */
		"mulx 32(%1),  %%r8, %%r10 ;" /* c*C[4] */
...
static void sqr_256x256_integer_x64_adx(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
		"movq   (%1), %%rdx        ;" /* A[0]      */
		"mulx  8(%1),  %%r8, %%r14 ;" /* A[1]*A[0] */
...
static void sqr_256x256_integer_x64_bmi2(u64 *const c, u64 *const a)
{
	__asm__ __volatile__(
		"movq  8(%1), %%rdx        ;" /* A[1]      */
		"mulx   (%1),  %%r8,  %%r9 ;" /* A[0]*A[1] */
...
static inline void sub_EltFp25519_1w_x64(u64 *const c, u64 *const a, u64 *const b)
{
	__asm__ __volatile__(
		"mov     $38, %%eax ;"
		"movq   (%1),  %%r8 ;"
...
static void inv_EltFp25519_1w_x64_adx(u64 *const c, u64 *const a)
{
#define sqrn_EltFp25519_1w_x64_adx(A, times) \
	counter = times; \
	while (counter-- > 0) { \
	...
	sqrn_EltFp25519_1w_x64_adx(T[1], 1);
	copy_EltFp25519_1w_x64(T[2], T[1]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 2);
	mul_EltFp25519_1w_x64_adx(T[0], a, T[2]);
	mul_EltFp25519_1w_x64_adx(T[1], T[1], T[0]);
	copy_EltFp25519_1w_x64(T[2], T[1]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 1);
	mul_EltFp25519_1w_x64_adx(T[0], T[0], T[2]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 5);
	mul_EltFp25519_1w_x64_adx(T[0], T[0], T[2]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 10);
	mul_EltFp25519_1w_x64_adx(T[2], T[2], T[0]);
	copy_EltFp25519_1w_x64(T[3], T[2]);
	sqrn_EltFp25519_1w_x64_adx(T[3], 20);
	mul_EltFp25519_1w_x64_adx(T[3], T[3], T[2]);
	sqrn_EltFp25519_1w_x64_adx(T[3], 10);
	mul_EltFp25519_1w_x64_adx(T[3], T[3], T[0]);
	copy_EltFp25519_1w_x64(T[0], T[3]);
	sqrn_EltFp25519_1w_x64_adx(T[0], 50);
	mul_EltFp25519_1w_x64_adx(T[0], T[0], T[3]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 100);
	mul_EltFp25519_1w_x64_adx(T[2], T[2], T[0]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 50);
	mul_EltFp25519_1w_x64_adx(T[2], T[2], T[3]);
	sqrn_EltFp25519_1w_x64_adx(T[2], 5);
	mul_EltFp25519_1w_x64_adx(T[1], T[1], T[2]);
#undef sqrn_EltFp25519_1w_x64_adx
}

static void inv_EltFp25519_1w_x64_bmi2(u64 *const c, u64 *const a)
{
#define sqrn_EltFp25519_1w_x64_bmi2(A, times) \
	counter = times; \
	while (counter-- > 0) { \
	...
	copy_EltFp25519_1w_x64(T[1], a);
	sqrn_EltFp25519_1w_x64_bmi2(T[1], 1);
	copy_EltFp25519_1w_x64(T[2], T[1]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 2);
	mul_EltFp25519_1w_x64_bmi2(T[0], a, T[2]);
	mul_EltFp25519_1w_x64_bmi2(T[1], T[1], T[0]);
	copy_EltFp25519_1w_x64(T[2], T[1]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 1);
	mul_EltFp25519_1w_x64_bmi2(T[0], T[0], T[2]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 5);
	mul_EltFp25519_1w_x64_bmi2(T[0], T[0], T[2]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 10);
	mul_EltFp25519_1w_x64_bmi2(T[2], T[2], T[0]);
	copy_EltFp25519_1w_x64(T[3], T[2]);
	sqrn_EltFp25519_1w_x64_bmi2(T[3], 20);
	mul_EltFp25519_1w_x64_bmi2(T[3], T[3], T[2]);
	sqrn_EltFp25519_1w_x64_bmi2(T[3], 10);
	mul_EltFp25519_1w_x64_bmi2(T[3], T[3], T[0]);
	copy_EltFp25519_1w_x64(T[0], T[3]);
	sqrn_EltFp25519_1w_x64_bmi2(T[0], 50);
	mul_EltFp25519_1w_x64_bmi2(T[0], T[0], T[3]);
	copy_EltFp25519_1w_x64(T[2], T[0]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 100);
	mul_EltFp25519_1w_x64_bmi2(T[2], T[2], T[0]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 50);
	mul_EltFp25519_1w_x64_bmi2(T[2], T[2], T[3]);
	sqrn_EltFp25519_1w_x64_bmi2(T[2], 5);
	mul_EltFp25519_1w_x64_bmi2(T[1], T[1], T[2]);
#undef sqrn_EltFp25519_1w_x64_bmi2
}
...
int crypto_scalarmult(u8 shared[CURVE25519_POINT_SIZE], const u8 private_key[CURVE25519_POINT_SIZE], const u8 session_key[CURVE25519_POINT_SIZE])
{
...
/*	__aligned(32) u8 private[CURVE25519_POINT_SIZE];*/
	...
	__attribute__ ((aligned (32))) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u64 workspace[6 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u8 session[CURVE25519_POINT_SIZE];
	__attribute__ ((aligned (32))) u8 private[CURVE25519_POINT_SIZE];
...
/*int curve25519_precomp_bmi2_base(u8 session_key[CURVE25519_POINT_SIZE], const u8 private_key[CURVE25519_POINT_SIZE])*/
int crypto_scalarmult_base(u8 session_key[CURVE25519_POINT_SIZE], const u8 private_key[CURVE25519_POINT_SIZE])
{
/*	__aligned(32) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];*/
/*	__aligned(32) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];*/
...
/*	__aligned(32) u8 private[CURVE25519_POINT_SIZE];*/
	...
	__attribute__ ((aligned (32))) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u64 workspace[4 * NUM_WORDS_ELTFP25519_X64];
	__attribute__ ((aligned (32))) u8 private[CURVE25519_POINT_SIZE];
