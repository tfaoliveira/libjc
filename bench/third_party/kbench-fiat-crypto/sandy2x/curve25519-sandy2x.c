...
typedef u64 fe[10];
typedef u64 fe51[5];
extern void curve25519_sandy2x_ladder(fe *, const u8 *);
extern void curve25519_sandy2x_ladder_base(fe *, const u8 *);
extern void curve25519_sandy2x_fe51_pack(u8 *, const fe51 *);
extern void curve25519_sandy2x_fe51_mul(fe51 *, const fe51 *, const fe51 *);
extern void curve25519_sandy2x_fe51_nsquare(fe51 *, const fe51 *, int);

static inline u32 le24_to_cpupv(const u8 *in)
{
	//return le16_to_cpup((__le16 *)in) | ((u32)in[2]) << 16;
  return *((u16 *)in) | ((u32)in[2]) << 16;
}
