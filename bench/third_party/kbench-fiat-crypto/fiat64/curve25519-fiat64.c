...
static __always_inline void fe_mul_impl(u64 out[5], const u64 in1[5], const u64 in2[5])
{
  ...
  { const u64 x15 = in2[1];
  { const u64 x13 = in2[0];
  { u128 x20 = (((u128)x5 * x18) + (((u128)x7 * x19) + (((u128)x9 * x17) + (((u128)x11 * x15) + ((u128)x10 * x13)))));
  { u128 x21 = ((((u128)x5 * x19) + (((u128)x7 * x17) + (((u128)x9 * x15) + ((u128)x11 * x13)))) + (0x13 * ((u128)x10 * x18)));
  { u128 x22 = ((((u128)x5 * x17) + (((u128)x7 * x15) + ((u128)x9 * x13))) + (0x13 * (((u128)x11 * x18) + ((u128)x10 * x19))));
  { u128 x23 = ((((u128)x5 * x15) + ((u128)x7 * x13)) + (0x13 * (((u128)x9 * x18) + (((u128)x11 * x19) + ((u128)x10 * x17)))));
  { u128 x24 = (((u128)x5 * x13) + (0x13 * (((u128)x7 * x18) + (((u128)x9 * x19) + (((u128)x11 * x17) + ((u128)x10 * x15))))));
  ...
  { u128 x33 = (x31 + x21);
  { u64 x34 = (u64) (x33 >> 0x33);
  { u64 x35 = ((u64)x33 & 0x7ffffffffffff);
  { u128 x36 = (x34 + x20);
  { u64 x37 = (u64) (x36 >> 0x33);
  { u64 x38 = ((u64)x36 & 0x7ffffffffffff);
  { u64 x39 = (x26 + (0x13 * x37));
  { u64 x40 = (x39 >> 0x33);
  { u64 x41 = (x39 & 0x7ffffffffffff);
  { u64 x42 = (x40 + x29);
  { u64 x43 = (x42 >> 0x33);
  { u64 x44 = (x42 & 0x7ffffffffffff);
  out[0] = x41;
  out[1] = x44;
  out[2] = (x43 + x32);
  out[3] = x35;
...
static __always_inline void fe_sqr_impl(u64 out[5], const u64 in1[5])
{
  ...
  { const u64 x4 = in1[1];
  { const u64 x2 = in1[0];
  { u128 x9 = (((u128)x2 * x7) + (((u128)x4 * x8) + (((u128)x6 * x6) + (((u128)x8 * x4) + ((u128)x7 * x2)))));
  { u128 x10 = ((((u128)x2 * x8) + (((u128)x4 * x6) + (((u128)x6 * x4) + ((u128)x8 * x2)))) + (0x13 * ((u128)x7 * x7)));
  { u128 x11 = ((((u128)x2 * x6) + (((u128)x4 * x4) + ((u128)x6 * x2))) + (0x13 * (((u128)x8 * x7) + ((u128)x7 * x8))));
  { u128 x12 = ((((u128)x2 * x4) + ((u128)x4 * x2)) + (0x13 * (((u128)x6 * x7) + (((u128)x8 * x8) + ((u128)x7 * x6)))));
  { u128 x13 = (((u128)x2 * x2) + (0x13 * (((u128)x4 * x7) + (((u128)x6 * x8) + (((u128)x8 * x6) + ((u128)x7 * x4))))));
  { u64 x14 = (u64) (x13 >> 0x33);
  { u64 x15 = ((u64)x13 & 0x7ffffffffffff);
  { u128 x16 = (x14 + x12);
  { u64 x17 = (u64) (x16 >> 0x33);
  { u64 x18 = ((u64)x16 & 0x7ffffffffffff);
  { u128 x19 = (x17 + x11);
  { u64 x20 = (u64) (x19 >> 0x33);
  { u64 x21 = ((u64)x19 & 0x7ffffffffffff);
  { u128 x22 = (x20 + x10);
  { u64 x23 = (u64) (x22 >> 0x33);
  { u64 x24 = ((u64)x22 & 0x7ffffffffffff);
  { u128 x25 = (x23 + x9);
  { u64 x26 = (u64) (x25 >> 0x33);
  { u64 x27 = ((u64)x25 & 0x7ffffffffffff);
  { u64 x28 = (x15 + (0x13 * x26));
  { u64 x29 = (x28 >> 0x33);
  { u64 x30 = (x28 & 0x7ffffffffffff);
  { u64 x31 = (x29 + x18);
  { u64 x32 = (x31 >> 0x33);
  { u64 x33 = (x31 & 0x7ffffffffffff);
  out[0] = x30;
  out[1] = x33;
  out[2] = (x32 + x21);
  out[3] = x24;
