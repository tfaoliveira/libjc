...
set output "../svg/chacha20_libjc_libsodium_static_disable_asm_xor_cycles_32_16384.svg"

plot \
\
"../csv/crypto_stream_chacha20_libsodium_static_disable_asm_16384.csv" using 1:2 title 'Libsodium (Scalar)' with lines, \
\
