...
set output "../svg/chacha20_libjc_hacl_star_compcert_xor_cycles_32_16384.svg"

plot \
\
"../csv/crypto_stream_chacha20_hacl_star_compcert_16384.csv" using 1:2 title 'HACL* (Scalar) ' with lines, \
\
