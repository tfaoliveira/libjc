...
set output "../svg/chacha20_libjc_libsodium_static_xor_cycles_32_16384.svg"
...
\
"../csv/crypto_stream_chacha20_libsodium_static_16384.csv" using 1:2 title 'Libsodium (AVX2)' with lines, \
\
