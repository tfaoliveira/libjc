...
plot "../csv/crypto_hash_sha3512_openssl_ref_16384.csv" using 1:2 title 'OpenSSL (Scalar)' with lines, \
"../csv/crypto_hash_sha3512_jazz_ref2x_16384.csv" using 1:2 title 'Jasmin (Scalar)' with lines, \
