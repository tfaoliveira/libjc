...
set output "../svg/shake128_openssl_cycles_128_16384.svg"
plot "../csv/crypto_hash_shake128_openssl_no_asm_16384.csv" using 1:2 title 'OpenSSL (no-asm)' with lines, \
"../csv/crypto_hash_shake128_openssl_scalar_16384.csv" using 1:2 title 'OpenSSL (Scalar)' with lines, \
