...
set output "../svg/sha3384_evercrypt_cycles_128_16384.svg"
plot "../csv/crypto_hash_sha3384_evercrypt_compact_gcc_16384.csv" using 1:2 title 'EverCrypt' with lines, \
