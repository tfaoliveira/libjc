...
set output "../svg/shake256_evercrypt_cycles_128_16384.svg"
plot "../csv/crypto_hash_shake256_evercrypt_compact_gcc_16384.csv" using 1:2 title 'EverCrypt' with lines, \
