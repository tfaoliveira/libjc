...
"csv/crypto_onetimeauth_poly1305_openssl_static_no_asm_512.csv" using 1:2 title 'OpenSSL 1.1.1 stable no-asm' with lines lc "yellow", \
"csv/crypto_onetimeauth_poly1305_openssl_static_ref_512.csv" using 1:2 title 'OpenSSL 1.1.1 stable (AVX2/AVX disabled)' with lines lc "green", \
