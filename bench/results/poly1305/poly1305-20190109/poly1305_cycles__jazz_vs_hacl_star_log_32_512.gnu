...
set output "poly1305_cycles__jazz_vs_hacl_star_log_32_512.svg"

plot \
"csv/crypto_onetimeauth_poly1305_hacl_star_compcert_512.csv" using 1:2 title 'HACL* (CompCert 3.4)' with lines lc "yellow", \
