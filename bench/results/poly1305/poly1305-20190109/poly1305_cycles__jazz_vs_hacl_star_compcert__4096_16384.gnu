...
set output "poly1305_cycles__jazz_vs_hacl_star_compcert__4096_16384.svg"

plot \
"csv/crypto_onetimeauth_poly1305_hacl_star_compcert_16384.csv" using 1:2 title 'HACL* (CompCert 8.1)' with lines lc "green", \
