...
set output "../svg/poly1305_libjc_libsodium_static_cycles_32_16384.svg"

plot \
\
"../csv/crypto_onetimeauth_poly1305_libsodium_static_16384.csv" using 1:2 title 'Libsodium (AVX2)' with lines, \
\
