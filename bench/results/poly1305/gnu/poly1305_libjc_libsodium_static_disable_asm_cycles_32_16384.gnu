...
set output "../svg/poly1305_libjc_libsodium_static_disable_asm_cycles_32_16384.svg"

plot \
\
"../csv/crypto_onetimeauth_poly1305_libsodium_static_disable_asm_16384.csv" using 1:2 title 'Libsodium (Scalar)' with lines, \
\
